...
public class ServiceTestWithData {
    ...
    @Before
    public void setUp() throws IOException, DogAlreadyExists {
    ...
    @Test
    public void readDogByID() throws IOException, DogNotFound {
        Dog testDog = new Dog("1222","Bodri",LocalDate.of(2012,10,11),DogSize.MIDDLING,35.2,16.2);
        Dog refDog = service.readDogById("1222");
        Assert.assertEquals(testDog.getId(),refDog.getId());
    }

    @Test
    public void removeDog() throws IOException, DogNotFound {
        Dog testDog = new Dog("1222","Bodri",LocalDate.of(2012,10,11),DogSize.MIDDLING,35.2,16.2);
